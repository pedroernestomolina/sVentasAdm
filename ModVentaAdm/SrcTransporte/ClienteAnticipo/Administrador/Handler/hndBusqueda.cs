...
namespace ModVentaAdm.SrcTransporte.ClienteAnticipo.Administrador.Handler
{
    ...
    {
        private OOB.Transporte.ClienteAnticipo.ListaMov.Filtro _filtro;


        public hndBusqueda()
        {
            _filtro = new OOB.Transporte.ClienteAnticipo.ListaMov.Filtro();
        }
        ...
        public IEnumerable<object>Buscar()
        {
            try
            {
                var r01 = Sistema.MyData.Transporte_Cliente_Anticipo_GetLista(_filtro);
