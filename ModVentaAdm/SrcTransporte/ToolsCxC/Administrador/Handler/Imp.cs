...
namespace ModVentaAdm.SrcTransporte.ToolsCxC.Administrador.Handler
{
    public class Imp: Vistas.IAdm
    {
        ...
        public string Get_TituloAdm { get { return "Administrador Documentos: Pagos Recibidos"; } }
        public int Get_CntItem { get { return _lista.Get_CntItem; } }
        public SrcTransporte.Filtro.Vistas.IFiltro CtrFiltro { get { return _ctrFiltro; } }
        ...
        public void Buscar()
        {
            if (_ctrFiltro.HndFiltro.VerificarFiltros())
            {
                ...
                if (r01 != null)
                {
                    ...
                    {
                        var nr = new dataItem((OOB.Transporte.CxcMovCobro.ListaMov.Ficha)rg);
                        lst.Add(nr);
                    }
