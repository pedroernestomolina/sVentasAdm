...
namespace ModVentaAdm.SrcTransporte.Reportes.Aliado.PorDetalleDoc
{
    public class Imp : IReporteConFiltro
    {
        ...
        private void imprimir(List<OOB.Transporte.Reporte.Aliado.DetalleDoc.Ficha> lst, string filtro)
        {
