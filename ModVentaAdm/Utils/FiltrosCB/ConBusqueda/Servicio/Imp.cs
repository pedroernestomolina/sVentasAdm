...
namespace ModVentaAdm.Utils.FiltrosCB.ConBusqueda.Servicio
{
    public class Imp: LibUtilitis.CtrlCB.ImpCB, ICtrlConBusqueda
    {
        ...
        public void ObtenerData()
        {
            try
            {
                ...
                var filtro = new OOB.Transporte.ServPrest.Busqueda.Filtro();
                var r01 = Sistema.MyData.TransporteServPrest_GetLista(filtro);
