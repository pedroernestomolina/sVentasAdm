...
namespace ModVentaAdm.Src.CxC.Tools.Reportes.ListaCtaPend
{
    ...
    public class RepCtaPend: IRepCtaPend
    {
        ...
        private List<PanelPrincipal.ListaCtasPend.data> _lst;
        ...
        public void setListaDoc(List<PanelPrincipal.ListaCtasPend.data> lst)
        {
            _lst = lst;
        }
        ...
        private void Imprimir()
        {
            ...
            foreach (var it in _lst.ToList())
            {
                ...
                rt["nombre"] = it.ciRif +Environment.NewLine+it.nombreRazonSocial;
                rt["importe"] = it.montoImporte ;
