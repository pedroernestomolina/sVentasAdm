...
{
    public class HndPanelCtas: PanelPrincipal.Pago.IPanelCtas
    {
        private object _idCliente;
        private DateTime _fechaServidor;
        private PanelPrincipal.Pago.ICtasPend _ctasPend;
        //
        public string GetMontoPagar { get { return decToStr(_ctasPend.GetMontoPagar); } }
