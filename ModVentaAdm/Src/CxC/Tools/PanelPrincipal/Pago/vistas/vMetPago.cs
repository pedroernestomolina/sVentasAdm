...
{
    public partial class vMetPago: Form
    {
        ...
        private void vMetPago_Load(object sender, EventArgs e)
        {
        ...
        private void vMetPago_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
