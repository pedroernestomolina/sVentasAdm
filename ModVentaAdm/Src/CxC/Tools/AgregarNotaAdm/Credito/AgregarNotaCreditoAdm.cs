...
namespace ModVentaAdm.Src.CxC.Tools.AgregarNotaAdm.Credito
{
    
    public class AgregarNotaCreditoAdm: IAgregarTipoNotaAdm
    {
        ...
        public bool CargarData()
        {
            ...
            var r02 = Sistema.MyData.CxC_Get_ContadorNotaCreditoAdm();
        ...
        {
            var r00 = Sistema.MyData.Sistema_TipoDocumento_GetFichaById(Sistema.Id_SistemaDocumento_NOTA_CREDITO_ADMINISTRATIVA_POC_COBRAR);
            ...
            if (rt == DialogResult.Yes)
            {
                ...
                var r01 = Sistema.MyData.CxC_AgregarNotaCreditoAdm(fichaOOb);
                if (r01.Result == OOB.Resultado.Enumerados.EnumResult.isError)
                {
                    Helpers.Msg.Error(r01.Mensaje);
                    return false;
