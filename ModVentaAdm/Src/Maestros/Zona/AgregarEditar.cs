...
namespace ModVentaAdm.Src.Maestros.Zona
{
    ...
    public class AgregarEditar
    {
        ...
        private OOB.Maestro.Zona.Entidad.Ficha _ficha;
        private bool _isOk;
        ...
        public OOB.Maestro.Zona.Entidad.Ficha FichaAgregadaActualizada { get { return _ficha; } }
        ...
        public void Editar(Maestros.data itActual)
        {
            ...
            if (CargarData())
            {
                var r01 = Sistema.MyData.ClienteZona_GetFichaById(itActual.id);
                if (r01.Result == OOB.Resultado.Enumerados.EnumResult.isError)
                {
                    Helpers.Msg.Error(r01.Mensaje);
                    return;
