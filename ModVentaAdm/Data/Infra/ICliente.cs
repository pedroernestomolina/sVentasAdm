...
namespace ModVentaAdm.Data.Infra
{
    public interface ICliente
    {
        ...
        OOB.Resultado.Lista<OOB.Maestro.Cliente.Documento.Ficha> 
            Cliente_Documentos_GetLista(OOB.Maestro.Cliente.Documento.Filtro filtro);
        OOB.Resultado.Lista<OOB.Maestro.Cliente.Articulos.Ficha> 
        ...
        OOB.Resultado.FichaEntidad<OOB.Maestro.Cliente.Editar.ObtenerData.Ficha> 
